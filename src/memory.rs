...
use crate::constants::{ARCH_DEFAULT, ARCH_MASK, Endianess, MM_EXEC, MM_READ, MM_SHARED, MM_WRITE, PAGE_MASK, PAGE_NMASK};
...
pub trait MemoryObject: Memory + Debug {
    ...
    fn add_memory_map(&mut self, map_va: i32, perms: i32, f_name: &str, data: &[u8], align: Option<i32>) -> i32 {
        ...
        if let Some(align) = align {
            ...
            let new_len = crate::utils::align(cur_len, align);
